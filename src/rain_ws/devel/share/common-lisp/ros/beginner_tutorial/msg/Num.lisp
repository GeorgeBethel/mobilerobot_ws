...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorial-msg:<Num> is deprecated: use beginner_tutorial-msg:Num instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorial-msg:name-val is deprecated.  Use beginner_tutorial-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorial-msg:first_name-val is deprecated.  Use beginner_tutorial-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorial-msg:last_name-val is deprecated.  Use beginner_tutorial-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorial-msg:age-val is deprecated.  Use beginner_tutorial-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorial-msg:score-val is deprecated.  Use beginner_tutorial-msg:score instead.")
  (score m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num>)))
  ...
  "1e2ccf68c27b7467042ee42406751622")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num)))
  "Returns md5sum for a message object of type 'Num"
  "1e2ccf68c27b7467042ee42406751622")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "string name~%string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "string name~%string first_name~%string last_name~%uint8 age~%uint32 score~%~%~%"))
