...
"""autogenerated by genpy from beginner_tutorial/Num.msg. Do not edit."""
import sys
...
class Num(genpy.Message):
  _md5sum = "1e2ccf68c27b7467042ee42406751622"
  _type = "beginner_tutorial/Num"
...
uint32 score
"""
  __slots__ = ['name','first_name','last_name','age','score']
  _slot_types = ['string','string','string','uint8','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,first_name,last_name,age,score
